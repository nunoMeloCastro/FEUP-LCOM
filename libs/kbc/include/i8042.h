...
/* MOVEMENT BREAK CODES */

#define UP_BREAK                0xC8    /* @brief Break code for up arrow key !!!NOTE: THIS IS A TWO BYTE CODE!!! */
#define DOWN_BREAK              0xD0    /* @brief Break code for down arrow key !!!NOTE: THIS IS A TWO BYTE CODE!!! */
#define LEFT_BREAK              0xCB    /* @brief Break code for left arrow key !!!NOTE: THIS IS A TWO BYTE CODE!!! */
#define RIGHT_BREAK             0xCD    /* @brief Break code for right arrow key !!!NOTE: THIS IS A TWO BYTE CODE!!! */

/* INPUT BREAK CODES */

#define KEY1                    0x82    /* @brief Break code for number 1 key */
#define KEY2                    0x83    /* @brief Break code for number 2 key */
#define KEY3                    0x84    /* @brief Break code for number 3 key */
#define KEY4                    0x85    /* @brief Break code for number 4 key */
#define KEY5                    0x86    /* @brief Break code for number 5 key */
#define KEY6                    0x87    /* @brief Break code for number 6 key */
#define KEY7                    0x88    /* @brief Break code for number 7 key */
#define KEY8                    0x89    /* @brief Break code for number 8 key */
#define KEY9                    0x8A    /* @brief Break code for number 9 key */
#define BACKSPACE               0x8E    /* @brief Break code for backspace key */
#define ENTER                   0x9C    /* @brief Break code for enter key */
